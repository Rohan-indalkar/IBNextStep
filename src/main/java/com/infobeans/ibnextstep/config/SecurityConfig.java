...
import com.infobeans.ibnextstep.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(List.of("*")); // tighten in application-prod.yml driven config later
